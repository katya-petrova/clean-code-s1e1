...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('input.main__task-input');
    var label=listItem.querySelector("label.main__task-label");
    var editBtn=listItem.querySelector(".main__edit-btn");
    var containsClass=listItem.classList.contains("main__list-item--edit");
    ...
    listItem.classList.toggle("main__list-item--edit");
};
...
//select ListItems children
    var checkBox=taskListItem.querySelector("input.main__checkbox");
    var editButton=taskListItem.querySelector("button.main__edit-btn");
    var deleteButton=taskListItem.querySelector("button.main__delete-btn");
